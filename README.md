...
# CraftReator - Minecraft Mod Maker

<img align="right" width="300" src="https://mcreator.net/image/about/about1.png">

CraftReator is a software used to make Minecraft Java Edition mods (neoforge), Minecraft Bedrock Edition Add-Ons (NOT MAINTAINED/DEPRECATED), and data packs using an intuitive easy-to-learn interface or with an integrated code editor. 

## Development

To clone this repository, run `git clone --recursive https://github.com/membercatcousin/CraftReator/`.
...
> [!IMPORTANT]
> NOT AN OFFICIAL MINECRAFT PRODUCT. NOT APPROVED BY OR ASSOCIATED WITH MOJANG OR MICROSOFT OR PYLO.
